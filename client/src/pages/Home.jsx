...
<span className='mt-[6px]'><lord-icon
    ...
    style={{width:'24px',height:'20px'}}>
      ...
      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10 '>
        {offerListings && offerListings.length > 0 && (
          <div className=''>
            <div className='my-3 md:px-16 lg:px-0 '>
              <h2 className='text-2xl font-semibold lg:font-bold text-gradient'>Recent offers</h2>
              <Link className='text-sm text-[#000080] hover:underline' to={'/search?offer=true'}>Show more offers</Link>
            </div>
     ...
     <p className='flex justify-center lg:justify-end lg:px-28'>   <Link
          to={'/search?offer=true'}
          className='text-xs sm:text-sm text-blue-800 font-bold hover:underline'
        >
         <button className='px-3 py-[2px] font-medium lg:font-bold button flex items-center justify-center gap-1 mt-2'>Explore More 
         
<span className='mt-[8px]'><lord-icon
    src="https://cdn.lordicon.com/whtfgdfm.json"
    trigger="hover"
      colors="primary:#ffffff"
        ...
        {rentListings && rentListings.length > 0 && (
          <div className=''>
            <div className='my-3 md:px-16 lg:px-0'>
              ...
              <Link className='text-sm text-[#000080] hover:underline' to={'/search?type=rent'}>Show more places for rent</Link>
            </div>
            <div className='flex flex-wrap gap-4 md:justify-center lg:justify-start'>
              {rentListings.map((listing) => (
                <ListingItem listing={listing} key={listing._id} />
        ...
        {saleListings && saleListings.length > 0 && (
          <div className=''>
            <div className='my-3 md:px-16 lg:px-0'>
              ...
              <Link className='text-sm text-[#000080] hover:underline' to={'/search?type=sale'}>Show more places for sale</Link>
            </div>
            <div className='flex flex-wrap gap-4 md:justify-center lg:justify-start'>
              {saleListings.map((listing) => (
                <ListingItem listing={listing} key={listing._id} />
